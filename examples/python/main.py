"""
Example: How to call the openrent-co-uk-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/openrent-co-uk-scraper
...
def run_actor():
    """Run the openrent-co-uk-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/openrent-co-uk-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.openrent.co.uk/properties-to-rent/greater-london?term=Greater%20London"}],
            "maxItems": 100,
